...
hutte/0.0.7 darwin-x64 node-v12.9.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [lib/commands/hutte/auth/login.js](https://github.com/hutte-io/cli/blob/v0.0.7/lib/commands/hutte/auth/login.js)_
...
_See code: [lib/commands/hutte/org/authorize.js](https://github.com/hutte-io/cli/blob/v0.0.7/lib/commands/hutte/org/authorize.js)_
<!-- commandsstop -->
